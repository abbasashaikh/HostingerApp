...
<head>
    ...
    <meta name="google-site-verification" content="Z1wZlMtdj8GZ8Ezw9fRz-hxlX_4LY-oiYGp3XlUtHAs" />
    <title>Nyati Equinox: Luxury 2, 3 & 4 BHK Flats in Bavdhan, Pune</title>
    <meta name="description" content="Nyati Equinox Bavdhan Chandani chowk  Pune - Premium 2, 3 & 4 BHK Flats starting from ₹98 Lakhs onwards. Possession Dec 2027. Discover premium 2 & 3 BHK flats at Dream Shelter, Bavdhan Pune. Modern design, top amenities & great location. Enquire now!">
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="canonical" href="https://dreamshelter.abstechsolution.co.in/" />
...
<div class="relative w-full h-64 sm:h-80 md:h-[500px] overflow-hidden">
  ...
  <div class="carousel-slide">
    <img src="gallery1.jpg" alt="Nyati Equinox banner" class="w-full h-full object-cover"
  ...
  <div class="carousel-slide hidden">
    <img src="gallery2.jpg" alt="Nyati Equinox" class="w-full h-full object-cover"
  ...
  <div class="carousel-slide hidden">
    <img src="gallery3.jpg" alt="Nyati Equinox" class="w-full h-full object-cover"
  ...
  <div class="carousel-slide hidden">
    <img src="gallery4.jpg" alt="Nyati Equinox" class="w-full h-full object-cover"
         onerror="this.src='https://placehold.co/600x400?text=Image+4';">
              <div class="gallery-overlay">
                    <h1>Luxury Living & Prime Retail</h1>
<p>Experience elegant residences with world-class shopping, vibrant streets, and timeless architecture.</p>
  ...
  <div class="absolute bottom-3 w-full flex justify-center space-x-2">
    ...
    <span class="dot w-2 h-2 sm:w-3 sm:h-3 bg-white rounded-full opacity-50 cursor-pointer"></span>
            ...
            <section id="about-us" class="bg-white p-6 rounded-lg shadow-lg mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 text-center">About Nyati Equinox</h2>
...
showSlide(slideIndex);
        ...
        document.addEventListener('DOMContentLoaded', () => {
          const form = document.getElementById('lead-form');
            ...
            function openModal(type, unit = '') {
                // FIX: Added null check to prevent errors if modal is missing (defensive coding)
                if (!modal) {
       ...
       // });
       //---------------------------------
        // Put this INSIDE your main DOMContentLoaded listener, after openModal is declared
        setTimeout(() => {
            if (typeof openModal === "function") {
                openModal('Get-Details');  // call modal
            }
        }, 2000);
        
        let modalShownOnScroll = false;
        window.addEventListener('scroll', () => {
            if (!modalShownOnScroll && typeof openModal === "function") {
                modalShownOnScroll = true;
                openModal('Get-Details');
            }
        });
        });
